    ...
    <section>
      <div>
        <div key={book._id} className=" max-w-[230px] border rounded-lg">
          ...
          />
          <div className="py-2 px-3" onClick={() => setShowBookDetail(true)}>
            <h2 className=" text-2xl font-bold uppercase overflow-hidden  max-h-9">
              {book.title}
            </h2>
            <h3 className="text-xl overflow-hidden  max-h-8">
              Author : {book.author}
            </h3>
